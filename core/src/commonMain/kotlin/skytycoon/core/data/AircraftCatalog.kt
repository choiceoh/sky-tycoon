...
object AircraftCatalog {
    val all: List<AircraftType> = listOf(
        ...
        AircraftType("b747_100", "B747-100", "보잉", 1970, 1986, 366, 9800, 900.0, 45e6, 12.5, 1450.0, 1050.0, 1.70, 8.0, bloc = "west"),
        AircraftType("dc10", "DC-10-30", "더글러스", 1972, 1989, 270, 10000, 900.0, 38e6, 9.5, 1160.0, 880.0, 1.40, 5.0, bloc = "west"),
        AircraftType("l1011", "L-1011 트라이스타", "록히드", 1972, 1984, 256, 7400, 900.0, 36e6, 9.2, 1180.0, 870.0, 1.40, 5.0, bloc = "west"),
        ...
        AircraftType("b747sp", "B747SP", "보잉", 1976, 1987, 290, 12300, 920.0, 50e6, 11.6, 1420.0, 1020.0, 1.60, 9.0, bloc = "west"),
        AircraftType("md80", "MD-80", "맥도넬더글러스", 1980, 1999, 155, 4600, 810.0, 30e6, 3.3, 500.0, 440.0, 0.65, 2.0, bloc = "west"),
        AircraftType("b767", "B767-300ER", "보잉", 1982, 2013, 218, 9700, 850.0, 62e6, 5.6, 780.0, 690.0, 1.10, 6.0, bloc = "west"),
        ...
        AircraftType("b747_400", "B747-400", "보잉", 1989, 2007, 416, 13400, 910.0, 148e6, 11.5, 1360.0, 1080.0, 1.70, 14.0, bloc = "west"),
        AircraftType("md11", "MD-11", "맥도넬더글러스", 1990, 2000, 293, 12600, 890.0, 112e6, 9.0, 1090.0, 880.0, 1.40, 7.0, bloc = "west"),
        AircraftType("a340", "A340-300", "에어버스", 1993, 2008, 295, 13500, 880.0, 126e6, 8.2, 1010.0, 870.0, 1.40, 9.0),
        AircraftType("b777", "B777-200ER", "보잉", 1997, 2018, 305, 14300, 900.0, 172e6, 7.9, 900.0, 800.0, 1.30, 12.0, bloc = "west"),
        ...
        AircraftType("b787", "B787-9", "보잉", 2014, 2040, 290, 14100, 900.0, 282e6, 5.7, 700.0, 780.0, 1.10, 15.0, bloc = "west"),
        ...
        AircraftType("b777_300er", "B777-300ER", "보잉", 2004, 2040, 396, 13650, 900.0, 320e6, 8.2, 900.0, 850.0, 1.35, 16.0, bloc = "west"),
        ...
        AircraftType("b787_10", "B787-10", "보잉", 2018, 2040, 336, 11750, 900.0, 338e6, 6.1, 730.0, 800.0, 1.15, 16.0, bloc = "west"),
        ...
        AircraftType("b777_9", "B777-9", "보잉", 2027, 2040, 426, 13500, 900.0, 442e6, 7.2, 850.0, 900.0, 1.30, 20.0, bloc = "west"),
